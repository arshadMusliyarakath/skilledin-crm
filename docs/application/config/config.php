...
|
*/
$config['base_url'] = 'http://localhost:8888/crm/docs/';
...
$csrfExclude = [
    'Utility/getCategoryReq',
    'Client/pushToDoc',
    'Client/CheckMobileExist',
    'Client/CheckEmailExist',
    'Client/CheckPassportExist',
    'Client/viewPdf',
    'Documentation/removeRequestedDoc',
    'Mail_Template/sendMail',
    'Documentation/deleteNote',
    'Documentation/changeProfileStatus',
    'Mail_Template/fetchTemplate',
    'Common/readNotification'
];
$config['csrf_exclude_uris'] = $csrfExclude;
