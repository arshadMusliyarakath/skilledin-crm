<?php
$iconColor =  $this->session->userdata('iconColor');
...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
    ...
    <head>
        ...
        <!-- NODE WAVES CSS -->
        <link href="<?= base_url('build/assets/libs/node-waves/waves.min.css'); ?>" rel="stylesheet"> 

        <!-- SIMPLEBAR CSS -->
        <link rel="stylesheet" href="<?= base_url('build/assets/libs/simplebar/simplebar.min.css'); ?>">
        <link rel="stylesheet" href="<?= base_url('build/assets/libs/simplebar/simplebar.min.css'); ?>">

        <!-- COLOR PICKER CSS -->
        <link rel="stylesheet" href="<?= base_url('build/assets/libs/flatpickr/flatpickr.min.css'); ?>">
        <link rel="stylesheet" href="<?= base_url('build/assets/libs/@simonwep/pickr/themes/nano.min.css'); ?>">
        ...
        <!-- JSVECTORMAP CSS -->
        <link rel="stylesheet" href="<?= base_url('build/assets/libs/jsvectormap/css/jsvectormap.min.css'); ?>">

        <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>

        <!-- MAIN CSS -->
        <link rel="stylesheet" href="<?= base_url('build/assets/mystyle.css?v=' . time()); ?>">
	...
	<body>
        ...
        <!-- LOADER -->
		<div id="loader">
			<img src="<?= base_url('build/assets/images/media/loader.svg'); ?>" alt="">
		</div>
		<!-- END LOADER -->
            ...
            <div class="main-content app-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0"><?= $page_name ?></h1>
                    </div>
                    <!-- Page Header Close -->
