    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-right">
            ...
            <?php
                ...
                $notifications  =   $this->Defualt_Model->findAll('notifications', array('receiver' => $user, 'status' => 0), array('id' => 'DESC'));
            ?>
                                            ...
                                            ?>
                                                <li class="dropdown-item">
                                                    <div class="d-flex align-items-start">
                                                        <div class="pe-2">
                                                            <span class="avatar avatar-md bg-<?= ($notify->theme) ? $notify->theme : 'primary' ?>-transparent avatar-rounded"><i class="ti ti-<?= ($notify->icon) ? $notify->icon : 'bell' ?> fs-18"></i></span>
                                                        </div>
                                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <a class='go-notify-link' href="<?= $notify->link ?>" data-notify-id='<?= $notify->id ?>'>    
                                                            ...
                                                            <div>
                                                                <a href="javascript:void(0);" data-notify-id='<?= $notify->id ?>' class="min-w-fit-content text-muted me-1 dropdown-item-close1 remove-notification"><i class="ti ti-x fs-16"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
