                ...
                <div class="head-bar">
                    ...
                    <div class="btn-area">
                        ...
                        <ul>
                            ...
                            <li><a href="<?= base_url('Documentation/addCaseManager') ?>"

                                    class="btn btn-primary mb-2">Add Case Manager</a></li>
                                ...
                                <table id="hidden-columns" class="table table-bordered text-nowrap w-100 dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class='btn btn-link'  href="<?= base_url('Common/MyClients/' . $user->id) ?>"><?= $user->name ?></a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('Documentation/viewCaseManager/' . $user->id) ?>"   
