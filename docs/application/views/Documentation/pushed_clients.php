        ...
        <div class="card custom-card">
            ...
            <div class="card-header">
                ...
                <div class="head-bar">
                    ...
                    <div class="card-title"> Pushed Client List</div>
                                ...
                                <table id="hidden-columns" class="table table-bordered text-nowrap w-100 dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            foreach ($pushed_clients as $key => $client) {

                                                $lastStageStatus = $this->Client_model->lastStageStatus($client->client_id);
                                        ...
                                        <tr>
                                            ...
                                            <td><a class='btn btn-link'
                                                    ...
                                                    href="<?= base_url('Client/docsView/' . $client->client_id) ?>"><?= $client->name ?></a>
