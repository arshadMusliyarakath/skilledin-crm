                  ...
                  <div class="card custom-card">
                     <div class="card-header">
                        <div class="head-bar">
                            ...
                            <div class="btn-area">
                                <ul>
                                    <li><a href="<?= base_url('Sales/addSalesConsultant') ?>" class="btn btn-primary mb-2">Add Sales Consultant</a></li>
                                </ul>
                            </div>
                        </div>
                     </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($users as $key => $user) {
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <td><?= $i ?></td>
                                                                <td><a class='btn btn-link' href="<?= base_url('Sales/viewSalesConsultant/' . $user->id) ?>" ><?= $user->name ?></a></td>
                                                                <td><?= $user->product_name ?></td>
                                                                <td><?= $user->email ?></td>
                                                                <td><i class="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block <?= $statusIcon ?>"></i> <?= $text ?></td>
                                                                <td>
                                                                    <a href="<?= base_url('Sales/MyClients/' . $user->id) ?>" class="btn btn-success"><i class="fa fa-users" aria-hidden="true"></i></a>
                                                                </td>
                                                            </tr>
                                                    <?php
                                                }
