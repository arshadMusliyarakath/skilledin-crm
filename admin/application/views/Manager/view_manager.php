                                ...
                                <div class="col-sm-12">
                                    <div class="p-sm-3 p-0">
                                        ...
                                        <div class="row gy-4 mb-4">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="number" class="form-control" name="mobile"
                                                    placeholder="Enter Mobile Number" pattern="[0-9]{10}" title="Please enter a 10-digit number" value="<?= $user->mobile?>"
                                                    required="">
                                            </div>
                                            <div class="col-xl-4">
                                       ...
                                       foreach ($manager_roles as $key => $manager_role) {
                                           ?>
                                                    <option
                                                        <?= ($manager_role->role_id == $user->role) ? 'selected'  : '' ?>
                                                        value="<?= $manager_role->role_id ?>"><?= $manager_role->role ?>
                                                    </option>
                                                    <?php
                                       }
                                       ?>
                                            ...
                                            <div class="col-xl-2">
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="switch-primary" name="status"
                                                        <?= ($user->status == 1) ? 'checked' : '' ?>>
                                                    <label class="form-check-label"
                                                        for="switch-primary"><?= ($user->status == 1) ? 'Active' : 'Inactive' ?></label>
                                                </div>
                                            </div>
                                        </div>
        </form>
...
<div class="card-footer">
    <div class="float-end">
        <a href="<?= base_url('Manager') ?>" class="btn btn-light m-1">Cancel</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href=<?= base_url('Manager/deleteManager/' . $user->id) ?> class="btn btn-danger">Yes,
                    delete</a>
            </div>
        </div>
    </div>
