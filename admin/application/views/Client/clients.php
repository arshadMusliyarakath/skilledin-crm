                                       ...
                                       <tbody>
                                            <?php
                                                ...
                                                foreach ($clients as $key => $client) {
                                                    ...
                                                    $view_link = ($client->case_manager != null) ? base_url('Client/docsView/' . $client->id) : base_url('Client/salesView/' . $client->id);
                                                    ?>
                                                            <tr>
                                                                <td><?= $i ?></td>
                                                                <td><?= $client->crm_number ?></td>
                                                                <td><a class='btn btn-link' href="<?= $view_link; ?>" ><?= $client->name ?></a></td>
                                                                <td><?= $client->email ?></td>
                                                                <td><?= ($client->handle_deprt == 1) ? 'Sales' : 'Documentation' ?></td>
                                                                <td><?= ($client->case_manager != null) ? $client->case_manager : $client->consultent_name ?></td>
