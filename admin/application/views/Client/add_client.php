                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="mobile"
                                                            id="mobile" placeholder="Enter Mobile Number"  pattern="[0-9]{10}" title="Please enter a 10-digit number" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="othersModalLabel">Others Qualification</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-text text-muted"><i
                                                                    class="bx bx-briefcase-alt-2"></i></div>
                                                            <input type="text" class="form-control" name="other-qualification"
                                                                placeholder="Enter Qualification Detials" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
