                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            ...
                                            <p class="mb-2 fs-12">
                                                <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0"><?= $registraionCount ?></span>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            ...
                                            <p class="mb-2 fs-12">
                                                <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0"><?= $caregiverCount ?></span>
                                                <span class="d-block fs-10 fw-semibold text-muted">THIS MONTH</span>
                                            </p>
                                            <a href="javascript:void(0);" class="fs-12 mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            ...
                                            <p class="mb-2 fs-12">
                                                <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0"><?= $canadaPRCount ?></span>
                                                <span class="d-block fs-10 fw-semibold text-muted">THIS MONTH</span>
                                            </p>
                                            <a href="javascript:void(0);" class="fs-12 mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            ...
                                            <p class="mb-2 fs-12">
                                                <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0"><?= $studyCount ?></span>
                                                <span class="d-block fs-10 fw-semibold text-muted">THIS MONTH</span>
                                            </p>
                                            <a href="javascript:void(0);" class="fs-12 mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                        </div>
