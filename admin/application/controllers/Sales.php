...
class Sales extends MY_Controller {
	...
	public function addSalesConsultant()
	{
		...
		if ($this->input->post()) {
			...
			$login_url		=		'https://sales.beskilledin.com/';
			$fromName		=		'CRM | '.$this->session->userdata('role_name');
			...
			$message 		= 		str_replace("**new_user_role**", $this->user_model->getUserRole(4), $message);
			...
			$this->Mail_Model->send($fromName, $to, $subject, $message, $cc = null);
