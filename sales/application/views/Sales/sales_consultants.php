        ...
        <div class="card custom-card">
            <div class="card-header">
                <div class="head-bar">
                    ...
                    <div class="btn-area">
                        <ul>
                            <li><a href="<?= base_url('Sales/addSalesConsultant') ?>" class="btn btn-primary mb-2">Add
                                    Sales Consultant</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class='btn btn-link'
                                                    href="<?= base_url('Sales/viewSalesConsultant/' . $user->id) ?>"><?= $user->name ?></a>
                                            </td>
                                            ...
                                            <td><i
                                                ...
                                                <?= $text ?></td>
                                            <td>
                                                <a href="<?= base_url('Sales/MyClients/' . $user->id) ?>"
