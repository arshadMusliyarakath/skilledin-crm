                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class='btn btn-link'
                                                    href="<?= base_url('Client/salesView/' . $client->id) ?>"><?= $client->name ?></a>
                                            </td>
                                            <td><?= $client->email ?></td>
                                            <td><?= $client->product_name ?></td>
                                            <td><?= $this->Common_model->ExplodeArray($client->requirement) ?></td>
                                            <td><span
                                                    class="badge bg-<?=$statusColur?>-gradient"><?=$statusText?></span>
                                            </td>
