                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            <p class="mb-2">
                                                <span class="fs-16">Registrations</span>
                                            </p>
                                            <p class="mb-2 fs-12">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6 pe-0">
                                            <p class="mb-2">
                                                <span class="fs-16">Care Giver</span>
                                            </p>
                                            <p class="mb-2 fs-12">
...
<?php $this->load->view('master/footer') ?>
        ...
        <link rel="modulepreload" href="<?= base_url('build/assets/simplebar-635bad04.js'); ?>" /><script type="module" src="<?= base_url('build/assets/simplebar-635bad04.js'); ?>"></script>
        ...
        <!-- JSVECTOR MAPS JS -->
        <script src="<?= base_url('build/assets/libs/jsvectormap/js/jsvectormap.min.js'); ?>"></script>

        <!-- JSVECTOR MAPS WORLD JS -->
        <script src="<?= base_url('build/assets/libs/jsvectormap/maps/world-merc.js'); ?>"></script>

        <!-- DATE & TIME PICKER JS -->
        <script src="<?= base_url('build/assets/libs/flatpickr/flatpickr.min.js'); ?>"></script>

        <!-- SALES-DASHNBOARD JS -->
        <link rel="modulepreload" href="<?= base_url('build/assets/sales-dashboard-8feed724.js'); ?>" /><script type="module" src="<?= base_url('build/assets/sales-dashboard-8feed724.js'); ?>"></script>

        <link rel="modulepreload" href="<?= base_url('build/assets/sales-simplebar-64292fa7.js'); ?>" /><script type="module" src="build/assets/sales-simplebar-64292fa7.js'); ?>"></script>        
        ...
        <!-- APP JS -->
        <link rel="modulepreload" href="<?= base_url('build/assets/app-3cade095.js'); ?>" /><script type="module" src="<?= base_url('build/assets/app-3cade095.js'); ?>"></script>
