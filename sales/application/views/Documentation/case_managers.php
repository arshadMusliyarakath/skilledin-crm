               ...
               <div class="col-xl-12">
                  <div class="card custom-card">
                     <div class="card-header">
                        <div class="head-bar">
                            <div class="card-title"> Case Managers List</div>
                            <div class="btn-area">
                                <ul>
                                    <li><a href="<?= base_url('Documentation/addCaseManager') ?>" class="btn btn-primary mb-2">Add Case Manager</a></li>
                                </ul>
                            </div>
                        </div>
                     </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($users as $key => $user) {
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <td><?= $i ?></td>
                                                                <td><a class='btn btn-link' href="<?= base_url('Manager/viewManager/' . $user->id) ?>" ><?= $user->name ?></a></td>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="btn btn-success"><i class="fa fa-users" aria-hidden="true"></i></a>
                                                                </td>
                                                            </tr>
                                                    <?php
                                                }
