...
class Utility extends MY_Controller {
	...
	public function getCategoryReq()
	{
		...
		$option = "<option value=''>Select Requirement</option>";
		$option = $option."<option value='UKVI/IELTS'>UKVI/IELTS</option>";
		$option = $option."<option value='UKNARIC'>UKNARIC</option>";
		$option = ($categoryId==2) ? $option."<option vlaue='Level 3'>Level 3</option>" : $option;
		$option = $option."<option value='Interview Training'>Interview Training</option>";
